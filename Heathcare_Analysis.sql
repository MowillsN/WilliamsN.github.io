...
-- 4. Calculating Patients Hospitalized Age-wise from oldest to youngest
...
-- 5. retriving the number of patients admitted by age.
SELECT AGE, COUNT(AGE) AS Total
FROM Healthcare
GROUP BY age
...
-- 7. Grouping patients by their medical condition
...
-- 9. Most used Insurance Provider by Hospatilized patients
